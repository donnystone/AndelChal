...
//CLASS 1:
    ...
    //This method calls the viewholder and attach each user in the
    // data to the recycler view and position it to the view
    @Override
    ...
    //Returns the number of items(users) on the list
    @Override
